...
- RC와 달리 **set based selector** 를 이용 가능[공식 문서](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#set-based-requirement)
