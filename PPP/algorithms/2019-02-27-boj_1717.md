...
이 문제는 **Union-find** 라는 자료구조를 이용하면 된다. 이 자료구조는 [Graph]({{site.baseurl}}/_posts/2019-01-12-Graph.md)에서 **Kruskal** 을 다룰 때에 살짝 다룬 부분이다.\\
하지만 Grpah 포스트에서 다룬 방식으로 하면 시간초과가 난다.
