...
name: 2019-01-15-CollaborativeFiltering.md
---
...
$$
cos(다크나이트,집으로)=\frac{0}{2}\\
cos(레미제라블,집으로)=\frac{-2}{2}\\
cos(군함도,집으로)=\frac{0}{2}
$$
...
이 때, $U$와 $V$는 *orthogonal* 한 성질이 있다.($UU^t = I$,$VV^t=I$)\\
(singular value는 $AA^t$의 eigenvalues의 양의 제곱근을 의미한다.)
...
위의 최소화를 r이 존재하는 모든 부분에서 진행한다.\\
SVD와 PCA의 더 정확한 수학적 구조는 다음에 다루도록 하겠다.
